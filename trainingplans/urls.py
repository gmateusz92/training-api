...
from .views import  ExerciseList, ExerciseCreate, ExerciseDetail, CategoryList, CategoryCreate, CategoryDetail, WorkoutPlanListView, WorkoutPlanCreate, WorokoutPlanDetail
...
urlpatterns = [
    ...
    path('workout-plans/<int:id>/', WorokoutPlanDetail.as_view(), name='workoutplan-detail'),
]